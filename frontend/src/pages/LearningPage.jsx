...
const styles = {
  ...
  heroBadge: { display: 'inline-block', background: '#D4A843', color: '#fff', padding: '0.5rem 1.3rem', borderRadius: '20px', fontSize: '1.05rem', fontWeight: '700', marginBottom: '1rem' },
  heroTitle: { fontSize: 'clamp(1.8rem, 5vw, 2.8rem)', fontWeight: '800', color: '#FFD700', margin: '0 0 1rem', lineHeight: 1.2 },
  heroText: { fontSize: '1.3rem', color: 'rgba(255,255,255,0.9)', lineHeight: 1.7, margin: 0, maxWidth: '650px' },
  cheroContainer: { flex: '0 1 520px', display: 'flex:', alignItems: 'center', justifyContent: 'center', },
  chero: { width: '520px', maxWidth: '100%', objectFit: 'contain', display: 'block', },
