...
const JoinGamePage = () => {
  ...
  const guidePages = [
    ...
    },
    {
      key: 'arrows',
      icon: '➡️',
      title: t('game.step1Title'),
      subtitle: '3 / 6',
      tabLabel: t('game.tabArrows'),
      rows: [
        { icon: '➡️', title: t('game.step1Blue'), bg: '#eff6ff', accent: '#2563eb', badge: null, arrowColor: '#2563eb' },
        { icon: '➡️', title: t('game.step1Purple'), bg: '#f3e8ff', accent: '#7B2FBE', badge: null, arrowColor: '#7B2FBE' },
        { icon: '➡️', title: t('game.step1Red'), bg: '#fee2e2', accent: '#dc2626', badge: null, arrowColor: '#dc2626' },
        { icon: '➡️', title: t('game.step1Gold'), bg: '#fef9ee', accent: '#D4A843', badge: null, arrowColor: '#D4A843' },
      ],
    },
    {
      key: 'checkpoints',
      icon: '🦷',
      title: t('game.step7Title'),
      subtitle: '4 / 6',
      tabLabel: t('game.tabCheckpoints'),
      rows: [
        { badge: '1', title: `Checkpoint 1: ${t('game.step7Cp1')}`, bg: '#eff6ff', accent: '#2563eb' },
        { badge: '2', title: `Checkpoint 2: ${t('game.step7Cp2')}`, bg: '#f3e8ff', accent: '#7B2FBE' },
        { badge: '3', title: `Checkpoint 3: ${t('game.step7Cp3')}`, bg: '#fee2e2', accent: '#dc2626' },
        { badge: '4', title: `Checkpoint 4: ${t('game.step7Cp4')}`, bg: '#fef9ee', accent: '#D4A843' },
      ],
    },
    {
      key: 'chat',
