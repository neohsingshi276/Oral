...
const { getPlayers, downloadCSV, getAnalytics, getSessionComparison, getAllAdmins, inviteAdmin, resendInvite, cancelInvite, completeRegistration, verifyInviteToken, deleteAdmin, deletePlayer, updateProfile, changePassword, updateAdminRole } = require('../controllers/admin.controller');
const verifyToken = require('../middleware/verifyToken');

router.get('/players', verifyToken, getPlayers);
router.get('/download-csv', verifyToken, downloadCSV);
router.get('/analytics', verifyToken, getAnalytics);
router.get('/compare-sessions', verifyToken, getSessionComparison);
